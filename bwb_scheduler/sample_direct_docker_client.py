...
from bwb_scheduler.workflow_docker_helpers.main_docker_workflow import DockerWorkflow
...
class ExecuteWorkflow:
    @workflow.run
    async def parse_ows(self, ows_xml: str, stack_id) -> None:
...
async def run_worker(stack_id=None):
    """
    Run the worker
